...
public class Calculadora extends JFrame {
    ...
    private void calcularResultado() {
        if (operacion.equals("+")) {
            ...
            resultado = Math.pow(resultado, 1.0/(new Double(pantalla.getText())));
        }else if (operacion.equals("Log")) {
            resultado = Math.log10(resultado)/Math.log10(new Double(pantalla.getText()));
        }
